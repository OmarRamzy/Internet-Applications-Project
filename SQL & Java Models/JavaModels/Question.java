...
public class Question {
   ...
   /** @pdRoleInfo migr=no name=Choice assc=questionChoice coll=java.util.Collection impl=java.util.HashSet mult=0..* */
   public java.util.Collection<Choice> choice;
   /** @pdRoleInfo migr=no name=QuestionAnswer assc=questionQuestionAnswer coll=java.util.Collection impl=java.util.HashSet mult=0..* */
